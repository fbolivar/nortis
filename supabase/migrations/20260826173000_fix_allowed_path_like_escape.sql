-- =============================================================================
-- Nortis | Arreglo: la carpeta autorizada nunca casaba en Windows
-- =============================================================================
-- BUG. La regla storage.carpeta_no_autorizada comparaba la ruta con
--   path LIKE allowed_path || '%'
-- y LIKE toma la barra invertida como caracter de ESCAPE por defecto. Una ruta
-- Windows como 'C:\Operaciones\nomina.txt' NUNCA casaba con el prefijo
-- 'C:\Operaciones%' (la '\O' se interpretaba como 'O' literal, sin la barra), de
-- modo que TODO archivo —incluso dentro de una carpeta autorizada— se marcaba
-- como guardado fuera de lista. La lista blanca de carpetas era, en la practica,
-- inoperante en Windows.
--
-- FIX. Se sustituye el LIKE por starts_with(), que compara prefijo literal sin
-- semantica de patron, y se compara en minusculas porque las rutas de Windows no
-- distinguen mayusculas. Es el unico cambio respecto a la version anterior.
